            ...
            <div className="max-w-2xl w-full">
                ...
                <div className="bg-white/90 border border-stone-200/50 backdrop-blur-md rounded-3xl p-8 shadow-xl mb-8 space-y-6 animate-fade-rise-delay">
                    <div className="text-center pb-6 border-b border-stone-200/50">
                        ...
                        <h3 className="text-2xl font-serif font-normal text-stone-900">
                            Welcome, <span className="italic text-secondary">{user.name}</span>
                        </h3>
                    ...
                    <div className={`grid grid-cols-1 ${user?.gender === 'male' ? 'md:grid-cols-2' : 'md:grid-cols-3'} gap-4`}>
                        ...
                        <div className="p-4 bg-background rounded-2xl text-center border border-stone-200/40">
                            ...
                            <p className="font-serif italic font-semibold text-secondary mt-1 text-sm">
                    ...
                    <div className="p-5 bg-background rounded-2xl border border-stone-200/50 text-center">
                ...
                <div className="space-y-4 animate-fade-rise-delay-2">
                    <button
                        ...
                        className="w-full py-4 rounded-full text-xs font-mono font-bold uppercase tracking-[0.2em] bg-primary text-white hover:bg-secondary active:scale-[0.98] transition-all duration-300 shadow-md cursor-pointer"
                    >
                        Enter Main Portal →
                    </button>
