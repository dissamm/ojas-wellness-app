...
export const PrakritiAssessment = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-12 bg-[#F4EFEA] text-[#1C1917] selection:bg-[#C27A5D]/10">
            <div className="max-w-2xl w-full">
                ...
                <div className="mb-6 sm:mb-8 animate-fade-rise">
                    ...
                    <div className="h-1.5 bg-stone-200/50 rounded-full overflow-hidden">
                        <div className="h-full bg-[#C27A5D] rounded-full transition-all duration-300" style={{ width: `${progress}%` }} />
                    </div>
                </div>
                ...
                <div className="bg-white/90 border border-stone-200/50 backdrop-blur-md rounded-3xl p-6 sm:p-8 md:p-10 shadow-xl animate-fade-rise-delay flex flex-col justify-between min-h-[500px]">
                    <div>
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-[10px] md:text-xs font-mono uppercase tracking-[0.2em] text-[#C27A5D] font-bold">
                                {question.category}
                            </span>
                              ...
                              return (
                                  <button
                                      ...
                                      className={`w-full text-left p-4 sm:p-5 rounded-2xl border transition-all duration-300 font-serif italic text-base sm:text-lg shadow-sm hover:translate-x-1 cursor-pointer leading-normal sm:leading-relaxed ${
                                          isSelected 
                                          ? 'border-[#C27A5D] bg-[#FAF6F0]/45 text-stone-950 ring-1 ring-[#C27A5D]/30' 
                                          : 'border-stone-200/80 bg-white/40 hover:border-[#C27A5D] hover:bg-[#FAF6F0]/30 text-stone-850 hover:text-stone-950'
                                      }`}
                                  >
                                      {opt.text}
                                  </button>
                    ...
                    <div className="mt-8 pt-6 border-t border-stone-100 space-y-6">
                        ...
                        <div className="p-4 sm:p-5 bg-[#F4EFEA] rounded-2xl border border-[#C27A5D]/10 flex gap-3.5 items-start relative overflow-hidden transition-all duration-300">
                            <div className="absolute top-0 right-0 w-20 h-20 bg-[#C27A5D]/5 rounded-full blur-xl pointer-events-none" />
                            <span className="text-xl sm:text-2xl mt-0.5 select-none leading-none">💡</span>
                            <div className="space-y-1">
                                <span className="text-[9px] font-mono uppercase tracking-[0.15em] text-[#C27A5D] font-bold block">
